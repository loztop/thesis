...
%permeability tensor
\newcommand{\perm}{\mathbf{\kappa}}
\newcommand{\perminv}{\mathbf{\kappa^{-1}}}
...
\newcommand{\pspacecont}{\mathcal{L}(\Omega)}
...
\newcommand{\elastspace}{\mathbf{W}^{E}}
\newcommand{\darcyspace}{\mathbf{W}^{D}}
\newcommand{\elastspacetest}{\mathbf{W}^{E}_{0}}
\newcommand{\darcyspacetest}{\mathbf{W}^{D}_{0}}
...
\newcommand{\perminvat}{\bar{\boldsymbol{\kappa}}^{-1}}
