...
The \textbf{particle derivative of a field} $\mathcal{G}(\boldsymbol{x},t)$ with respect to the particle $\alpha$ ($s$ or $f$) is given by %(see section 1.3.1 in \cite{coussy2004poromechanics})
%(see \citep[eqn. (1.43)]{coussy2004poromechanics})
\begin{equation}
