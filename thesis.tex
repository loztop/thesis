...
%\input{/users/lorenzb/Dphil/poroelasticity_papers/ima_submission/defines_poro}
\input{contents/defines_thesis}
...
\input{contents/introduction_chapter}
 
\chapter{Background}
\input{contents/background_chapter}

\chapter{Poroelasticity theory}
\input{contents/poroelasticity_chapter}
...
\label{chap:linear_fem}
%\begin{abstractchap}
% \input{/users/lorenzb/Dphil/poroelasticity_papers/large_deformation/contents/abstract}
%\end{abstractchap}
...
\input{/users/lorenzb/Dphil/poroelasticity_papers/large_deformation/contents/conclusion}
%
%%Coupled lung model
...
%\begin{abstractchap}
% \input{/users/lorenzb/Dphil/poroelasticity_papers/coupling_paper/contents/abstract}
%\end{abstractchap}

%\input{/users/lorenzb/Dphil/poroelasticity_papers/coupling_paper/contents/introduction}
...
\input{/users/lorenzb/Dphil/poroelasticity_papers/coupling_paper/contents/implementation}
\input{/users/lorenzb/Dphil/poroelasticity_papers/coupling_paper/contents/model_generation}
\input{/users/lorenzb/Dphil/poroelasticity_papers/coupling_paper/contents/simulation_lung}
\input{/users/lorenzb/Dphil/poroelasticity_papers/coupling_paper/contents/conclusion}
...
%% Conclusion
\chapter{Conclusion}
\input{contents/conclusion_chapter}
